...
El remitente configurado en el codigo es `Aula Evaluación DGAS <aulaevaluaciondgas@gmail.com>`. Ese correo debe estar validado/autorizado como sender en Brevo. Si el envio falla, revisa Render Logs; los errores aparecen con el prefijo `[EMAIL]`.
