...
const EMAIL_FROM = process.env.EMAIL_FROM || "jonathanvaldespino340049@gmail.com";
...
async function sendResultEmail(person, attempt) {
  ...
  try {
    ...
    console.log(`[EMAIL] Enviando resultado por Brevo API a ${attempt.email} desde Aula Evaluacion DGAS <${EMAIL_FROM}>.`);
