...
function renderCourseSelectors() {
  ...
  $("questionCount").textContent = evaluation.includeSurvey === false ? `${evaluation.questionCount || currentQuestions().length} reactivos` : `${evaluation.questionCount || 15} + 5`;
...
function selectedExamQuestions() {
  ...
  const limit = currentEvaluation().questionCount || questionBank.length || 15;
